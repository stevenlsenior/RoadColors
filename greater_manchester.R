...
if(!file.exists(england_shp.zip)){
  u <- "http://download.geofabrik.de/europe/great-britain/england-latest-free.shp.zip"
  download.file(url = u,
                destfile = "england_shp.zip")
}

unzip.file("england_shp.zip")
